...
# positive numbers.
INDIVIDUAL_ARG_WEIGHTS = {
    "arg_quality":   0.40,   # argument-level (Part 1): ES claim+premise / fallback
    "nli":           0.25,   # argument-level (Part 1): corpus grounding
    "delta":         0.20,   # debate-level  (Part 2): engaged vs parallel  ("the central question")
    "votes":         0.15   # debate-level  (Part 2): % of opponent answered
   }
DEBATE_LEVEL_WEIGHTS = {
    "rebuttal_effectiveness": 0.30,
    "argument_quality": 0.27,
    "engagement_parallel": 0.25,
